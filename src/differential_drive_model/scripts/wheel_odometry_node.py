...
Also logs IMU data for comparison plots
"""
...
class WheelOdometryNode(Node):
    ...
    def init_csv_files(self):
        ...
        with open(self.imu_file, 'w', newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['timestamp', 'omega_z', 'accel_x', 'accel_y', 'accel_z'])

    def imu_callback(self, msg):
        """Store and log IMU data"""
